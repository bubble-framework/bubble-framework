...
const commandsOutOfOrder = (command) => (
  `Oops! Couldn' finish executing \`bubble ${command}\`. Always make sure you're executing commands in the correct order: init, list/detail, dashboard/destroy, teardown ${emoji.get('wink')}`
);
